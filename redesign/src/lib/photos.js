// Google Drive photo IDs, grouped loosely by location.
// Rendered as one combined gallery (see /photos).
export const PHOTOS = {
	nyc: [
		'1EZesQ4rA0vaGb4Hp_7f-8wtvJQiws_xd',
	...
	stk: [
		'1PRi_elXLjEux7RO9fy5IACbp6Jtqz0El',
	...
	cali: [
		'1xSXqQlIReUf7cMLV-3ZKZ1U_Q3RyIREg',
	...
	other: [
		'1pYyDE6p5MXmYvIYcdDA4CCLnwcMZ15oG',
	...
	chi: [
		'1lwxpyXwm0u2R-SZEEDjivho-NavmvVco',
...
// Flattened, in category order — matches the original gallery's render order.
export const PHOTO_IDS = Object.values(PHOTOS).flat();
